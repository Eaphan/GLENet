        ...
        if 'annos' in info:
            ...
            if self.training and self.dataset_cfg.get('FILTER_EMPTY_BOXES_FOR_TRAIN', False):
                ...
                if 'uncertainty' in annos:
                    annos['uncertainty'] = annos['uncertainty'][mask]

            if 'uncertainty' in annos:
                input_dict.update({'gt_uncertaintys': annos['uncertainty']})
...
def create_waymo_infos(dataset_cfg, class_names, data_path, save_path,
    ...
    dataset.create_groundtruth_database(
        ...
        used_classes=['Vehicle'], processed_data_tag=processed_data_tag
    )
