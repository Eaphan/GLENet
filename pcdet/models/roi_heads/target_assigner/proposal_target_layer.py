...
class ProposalTargetLayer(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        Returns:
            batch_dict:
                ...
                rcnn_cls_labels: (B, M)
        """
        batch_rois, batch_gt_of_rois, batch_roi_ious, batch_roi_scores, batch_roi_labels, batch_gt_uncertaintys_of_rois = self.sample_rois_for_rcnn(
        ...
        targets_dict = {'rois': batch_rois, 'gt_of_rois': batch_gt_of_rois, 'gt_iou_of_rois': batch_roi_ious,
                        ...
                        'rcnn_cls_labels': batch_cls_labels, 'gt_uncertaintys_of_rois': batch_gt_uncertaintys_of_rois}
    ...
    def sample_rois_for_rcnn(self, batch_dict):
        ...
        if 'gt_uncertaintys' in batch_dict:
            ...
            gt_uncertaintys = None
            batch_gt_uncertaintys_of_rois = None
        ...
        for index in range(batch_size):
            ...
            if gt_uncertaintys is not None:
                cur_uncertainty = gt_uncertaintys[index][:k+1]
            ...
            if batch_gt_uncertaintys_of_rois is not None:
                batch_gt_uncertaintys_of_rois[index] = cur_uncertainty[gt_assignment[sampled_inds]]

        return batch_rois, batch_gt_of_rois, batch_roi_ious, batch_roi_scores, batch_roi_labels, batch_gt_uncertaintys_of_rois
